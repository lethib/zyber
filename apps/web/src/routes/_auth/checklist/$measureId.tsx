    ...
    <div className="px-6 py-8">
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-3">
          ...
          <h1 className="text-xl font-semibold text-zinc-900 leading-snug">{currentMeasure.title}</h1>
          <p className="text-sm text-muted-foreground leading-relaxed">{currentMeasure.description}</p>
        </div>
