...
const STATUS_OPTIONS: Array<{ value: EvaluationStatus; label: string; activeClass: string }> = [
  {
    value: 'NotStarted',
    label: 'Non commencé',
    activeClass: 'data-[state=on]:bg-slate-100 data-[state=on]:text-slate-600 data-[state=on]:border-slate-400',
  },
  {
    value: 'InProgress',
    label: 'En cours',
    activeClass: 'data-[state=on]:bg-amber-50 data-[state=on]:text-amber-600 data-[state=on]:border-amber-400',
  },
  {
    value: 'Achieved',
    label: 'Atteint',
    activeClass: 'data-[state=on]:bg-green-50 data-[state=on]:text-green-700 data-[state=on]:border-green-400',
  },
  {
    value: 'NotApplicable',
    label: 'Non applicable',
    activeClass: 'data-[state=on]:bg-slate-50 data-[state=on]:text-slate-400 data-[state=on]:border-slate-300 data-[state=on]:italic',
  },
]
