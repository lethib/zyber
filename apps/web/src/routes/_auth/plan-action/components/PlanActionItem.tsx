...
const STATUS_CONFIG = {
	NotStarted: {
		...
		dot: "bg-slate-300",
		badge:
			"text-slate-500 bg-zinc-100 border border-zinc-200 hover:bg-amber-50 hover:text-amber-600 hover:border-amber-300",
	...
	InProgress: {
		...
		dot: "bg-amber-400",
		badge:
			"text-amber-600 bg-amber-50 border border-amber-200 hover:bg-slate-50 hover:text-slate-500 hover:border-slate-200",
			...
			<div className="flex items-center gap-2 shrink-0">
				...
				{cfg && (
					<Button
						...
						title={cfg.title}
						className={`h-auto gap-1.5 rounded-full px-2.5 py-1 text-xs font-medium select-none ${cfg.badge}`}
					>
				...
				<Button
					...
					variant="ghost"
					size="icon"
					className="size-7 text-zinc-300 hover:bg-zinc-100 hover:text-zinc-600"
				>
